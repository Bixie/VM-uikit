...
?>
<div class="billto-shipto uk-form uk-margin-top">
	<div class="uk-grid" data-uk-grid-match="{target:'.uk-inner'}">
		<div class="uk-width-1-2">
			<div class="uk-panel uk-panel-box">
				<fieldset>
					<legend><i class="uk-icon-money uk-margin-small-right"></i>
						<?php echo JText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></legend>
					...
					<div class="uk-inner">
						<div class="output-billto">
							...
							echo plgSystemBixsystem::formatVMadres($this->cart->BTaddress['fields']);
							?>
						</div>

					</div>
					<div class="uk-text-right">
						<a class="uk-button uk-button-small" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
							<i class="uk-icon-edit uk-margin-small-right"></i><?php echo JText::_ ('COM_VIRTUEMART_USER_FORM_EDIT_BILLTO_LBL'); ?>
						</a>
					</div>
		...
		<div class="uk-width-1-2">
			<div class="uk-panel uk-panel-box">
				<fieldset>
					<legend><i class="uk-icon-truck uk-margin-small-right"></i>
						<?php echo JText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></legend>
					...
					<div class="uk-text-right">
						<a class="uk-button uk-button-small" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
							<i class="uk-icon-plus uk-margin-small-right"></i><?php echo JText::_ ('COM_VIRTUEMART_USER_FORM_ADD_SHIPTO_LBL'); ?>
						</a>
					</div>
				</fieldset>
			</div>
...
<div class="cart-products uk-form uk-margin-top">
	<div class="uk-grid">
		<div class="uk-width-1-1">
			<div class="uk-panel uk-panel-box">
				<fieldset>
					<legend><i class="uk-icon-shopping-cart uk-margin-small-right"></i>
						<?php echo JText::_ ('COM_VIRTUEMART_ORDER_ITEM'); ?></legend>

					<table
						class="uk-table uk-table-condensed cart-summary uk-margin-remove"
						cellspacing="0"
						cellpadding="0"
						border="0"
						width="100%">
					...
					foreach ($this->cart->products as $pkey => $prow) {
						?>
					<tr valign="top" class="uk-productrow sectiontableentry<?php echo $i ?>">
						<td align="left">
							<?php if ($prow->virtuemart_media_id) { ?>
							<div class="uk-comment-header">
								<?php
									if (!empty($prow->image)) {
										echo $prow->image->displayMediaThumb ('class="uk-comment-avatar" style="max-height:75px;"', FALSE);
									}
									?>
								<?php } ?>
								<h4 class="uk-comment-title"><?php echo JHTML::link ($prow->url, $prow->product_name) . $prow->customfields; ?></h4>
								<div class="uk-comment-meta"><?php  echo $prow->product_sku ?></div>
							</div>
						</td>
						<td align="center">
							<?php
					...
					//				$step=$prow->min_order_level;
							...
							<form action="<?php echo JRoute::_ ('index.php'); ?>" method="post" class="inline">
								...
								<button class="uk-button uk-button-mini" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>"><i class="uk-icon-refresh"></i></button>
								<a class="uk-button uk-button-mini uk-button-danger" title="<?php echo JText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" align="middle" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart&task=delete&cart_virtuemart_product_id=' . $prow->cart_item_id) ?>" rel="nofollow">
