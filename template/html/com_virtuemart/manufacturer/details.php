...
<div class="manufacturer-details-view">
	...
	<div class="uk-grid">
		<div class="uk-width-medium-<?php echo $firstCol; ?>">
			<div class="uk-panel uk-panel-box">
				...
				if (!empty($this->manufacturer->mf_email)) {
					?>
					<a class="uk-display-block" target="_self"
					   href="mailto:<?php echo $this->manufacturer->mf_email; ?>">
		...
		<div class="uk-width-medium-<?php echo $secCol; ?>">
			...
			if (!empty($this->manufacturer->virtuemart_manufacturer_id)) {
				...
				<div class="uk-clearfix">
					<a class="uk-button uk-button-small uk-float-right" target="_self"
					   href="<?php echo $manufacturerProductsURL; ?>">
