...
$body_classes .= ' ' . 'tm-article-' . $this['config']->get('article_style');
$body_classes .= $this['config']->get('sticky_navbar') ? ' tm-sticky-navbar' : '';
...
$this['asset']->addFile('css', 'css:sticky.almost-flat.min.css');
