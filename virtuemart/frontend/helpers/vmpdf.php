...
// 			$this->SetDefaultMonospacedFont(PDF_FONT_MONOSPACED);
		...
		function replace_variables ($txt) {
			...
			$txt = str_replace('{vm:pagenum}', $this-> /*getAliasNumPage*/
			PageNo(), $txt);
			...
			$txt = str_replace('{vm:pagecount}', $this->getAliasNbPages /*getNumPages*/
			(), $txt);
...
// 			$cell_height = round(($this->cell_height_ratio * $headerfont[2]) / $this->k, 2);
				...
				$this->writeHTMLCell($cw, /*$cell_height*/
					0, $this->x, $this->header_margin, $headertxt, '', /*$ln=*/
					2, false, /*$reseth*/
					true, '', /*$autopadding=*/
					true);
